    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IConfiguration configuration)
        {
            ...
            app.Use(async (context, next) =>
            {
                ...
                context.Response.Headers["Content-Security-Policy"] = "default-src 'self'; img-src 'self' *.googletagmanager.com *.google-analytics.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' *.googletagmanager.com *.google-analytics.com *.googleapis.com; font-src 'self' data:; connect-src 'self' 'unsafe-inline' *.googletagmanager.com *.google-analytics.com; *.tagmanager.google.com; *.www.google-analytics.com; *.googleadservices.com; *.g.doubleclick.net; *.adnxs.com;*.youtube-nocookie.com; *.licdn.com; *.twitter.com; *.ads-twitter.com ;*.facebook.net;";
