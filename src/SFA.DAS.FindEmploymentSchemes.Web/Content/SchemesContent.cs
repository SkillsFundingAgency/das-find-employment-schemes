...
Find out <a href=""https://www.gov.uk/guidance/traineeship-information-for-employers"" title="""" class=""govuk-link"">how traineeships can benefit your business</a>.</p>"),
            ...
            new Scheme("Care-Leaver covenant",
                ...
                new HtmlString(
                    @"<p class=""govuk-body"">Employers provide:</p><ul class =""govuk-list govuk-list--bullet""><li>a safe work environment</li><li>an induction which includes explaining relevant policies and procedures</li><li>practical help that makes a difference to the life of a care leaver</li></ul><p class=""govuk-body""></p>"),
                new HtmlString(
            ...
            new Scheme("Employing prisoners and prison leavers",
                ...
                new HtmlString(
                    @"<p class=""govuk-body"">Employers provide:</p><ul class =""govuk-list govuk-list--bullet""><li>a safe work environment</li><li>a line manager to support, supervise and mentor</li><li>an induction which includes explaining relevant policies and procedures</li></ul><p class=""govuk-body""></p>"),
                new HtmlString(
