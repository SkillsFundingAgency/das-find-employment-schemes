    ...
    public class SchemesModelServiceTests
    {
        ...
        public class PreviewErrorTestData : IEnumerable<object[]>
        {
            public IEnumerator<object[]> GetEnumerator()
            {
                ...
                yield return new object[] { "If there is no details page override, the description must not be blank", new Scheme("name", "shortname", "visitSchemeInformation", new HtmlString("shortDescription"), new HtmlString("shortCost"), new HtmlString("shortBenefits"), new HtmlString("shortTime"), "comparisonRecruitOrTrain", "comparisonAgeCriteria", "comparisonCost", "comparisonDuration", "url", 0, new List<SchemeFilterAspect>(), Enumerable.Empty<string>(), Enumerable.Empty<CaseStudy>(), new HtmlString("caseStudiesPreamble"), null, "offer header") };
                yield return new object[] { "If there is no details page override and no sub schemes, the cost must not be blank", new Scheme("name", "shortname", "visitSchemeInformation", new HtmlString("shortDescription"), new HtmlString("shortCost"), new HtmlString("shortBenefits"), new HtmlString("shortTime"), "comparisonRecruitOrTrain", "comparisonAgeCriteria", "comparisonCost", "comparisonDuration", "url", 0, new List<SchemeFilterAspect>(), Enumerable.Empty<string>(), Enumerable.Empty<CaseStudy>(), new HtmlString("caseStudiesPreamble"), null, "offer header") };
                yield return new object[] { "If there is no details page override and no sub schemes, the responsibility must not be blank", new Scheme("name", "shortname", "visitSchemeInformation", new HtmlString("shortDescription"), new HtmlString("shortCost"), new HtmlString("shortBenefits"), new HtmlString("shortTime"), "comparisonRecruitOrTrain", "comparisonAgeCriteria", "comparisonCost", "comparisonDuration", "url", 0, new List<SchemeFilterAspect>(), Enumerable.Empty<string>(), Enumerable.Empty<CaseStudy>(), new HtmlString("caseStudiesPreamble"), null, "offer header") };
                yield return new object[] { "If there is no details page override and no sub schemes, the benefits must not be blank", new Scheme("name", "shortname", "visitSchemeInformation", new HtmlString("shortDescription"), new HtmlString("shortCost"), new HtmlString("shortBenefits"), new HtmlString("shortTime"), "comparisonRecruitOrTrain", "comparisonAgeCriteria", "comparisonCost", "comparisonDuration", "url", 0, new List<SchemeFilterAspect>(), Enumerable.Empty<string>(), Enumerable.Empty<CaseStudy>(), new HtmlString("caseStudiesPreamble"), null, "offer header") };
                yield return new object[] { "If there is no details page override and no sub schemes, the offer header must not be blank", new Scheme("name", "shortname", "visitSchemeInformation", new HtmlString("shortDescription"), new HtmlString("shortCost"), new HtmlString("shortBenefits"), new HtmlString("shortTime"), "comparisonRecruitOrTrain", "comparisonAgeCriteria", "comparisonCost", "comparisonDuration", "url", 0, new List<SchemeFilterAspect>(), Enumerable.Empty<string>(), Enumerable.Empty<CaseStudy>(), new HtmlString("caseStudiesPreamble"), null, null) };
