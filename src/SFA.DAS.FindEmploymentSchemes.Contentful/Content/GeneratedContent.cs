        ...
        public IEnumerable<Scheme> Schemes => _schemes ??= new[]
        {
            ...
            new Scheme("Apprenticeships",
             ...
             new string[] {                "pay--minimum-wage", "motivations--full-time-role", "motivations--diversity-or-responsibility", "scheme-length--4-months-to-12-months", "scheme-length--a-year-or-more"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Incentive payments are available for each apprentice a business takes on as a new employee.
            ...
            new Scheme("T Levels: industry placements",
                ...
                new HtmlString(@"<p class=""govuk-body"">Industry placements can save on many of the costs associated with recruitment</p>"),
            ...
            new Scheme("Skills Bootcamps",
                ...
                new HtmlString(@"<p class=""govuk-body"">Helps future-proof your business in a rapidly changing labour market and recruit staff with the right training and skills from the outset</p>"),
             ...
             new string[] {                "pay--unpaid", "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--unpaid-placement", "motivations--full-time-role", "scheme-length--4-months-to-12-months", "scheme-length--up-to-4-months"             },
                null,
                new HtmlString(@"<p class=""govuk-body"">Skills Bootcamps offer free, flexible courses of up to 16 weeks for adults aged 19 or over and who are either in work, self-employed, recently unemployed or returning to work after a break.</p><p class=""govuk-body"">They give people the opportunity to build up valuable sector-specific skills based on local employer demand in areas including digital, construction and green skills.</p><p class=""govuk-body"">They provide a direct path to a job on completion.</p>"),
                new HtmlString(@"<p class=""govuk-body"">Employers who want to use Skills Bootcamps for their existing employees contribute 30% of the cost.</p><p class=""govuk-body"">Existing employees may need time to study and attend classes depending on their working hours and status and the flexibility of the course.</p>"),
            ...
            new Scheme("Traineeships",
                ...
                new HtmlString(@"<p class=""govuk-body"">Free government scheme but you may have your own business costs</p>"),
                new HtmlString(@"<p class=""govuk-body"">Helps you increase your capacity and productivity whilst developing a loyal and talented workforce</p>"),
             ...
             new string[] {                "pay--unpaid", "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--unpaid-placement", "motivations--full-time-role", "scheme-length--4-months-to-12-months", "scheme-length--up-to-4-months"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Traineeships have seen big increases as businesses recover from the pandemic and are expected to double to around 40,000 per year.</p><p class=""govuk-body"">
...
Find out <a href=""https://www.gov.uk/guidance/traineeship-information-for-employers"" title="""" class=""govuk-link"">how traineeships can benefit your business</a>.</p>"),
            ...
            new Scheme("Supported Internships for learners with an education, health and care plan",
                new HtmlString(@"<p class=""govuk-body"">An unpaid 6 to 12-month work placement for 16 to 24-year-olds with additional needs supported by a qualified job coach.</p>"),
                new HtmlString(@"<p class=""govuk-body"">Free government scheme but you may have your own business costs.</p>"),
                new HtmlString(@"<p class=""govuk-body"">Allows you to shape a job role that suits your business and the needs of the supported intern and increases your confidence of employing individuals with additional needs</p>"),
            ...
            new Scheme("Care-Leaver covenant",
             ...
             new string[] {                "pay--unpaid", "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--unpaid-placement", "motivations--full-time-role", "scheme-length--a-year-or-more", "scheme-length--4-months-to-12-months", "scheme-length--up-to-4-months"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Employers provide:</p><ul class =""govuk-list govuk-list--bullet""><li>a safe work environment</li><li>an induction which includes explaining relevant policies and procedures</li><li>practical help that makes a difference to the life of a care leaver</li></ul><p class=""govuk-body""></p>"),
            ...
            new Scheme("Employing prisoners and prison leavers",
             ...
             new string[] {                "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--full-time-role", "scheme-length--a-year-or-more", "scheme-length--4-months-to-12-months", "scheme-length--up-to-4-months"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Employers provide:</p><ul class =""govuk-list govuk-list--bullet""><li>a safe work environment</li><li>a line manager to support, supervise and mentor</li><li>an induction which includes explaining relevant policies and procedures</li></ul><p class=""govuk-body""></p>"),
            ...
            new Scheme("Higher Technical Qualifications (HTQs)",
                new HtmlString(@"<p class=""govuk-body"">Level 4 or 5 qualifications, for those 18 and over, with no work placement but flexible for employees to study while working.</p>"),
                new HtmlString(@"<p class=""govuk-body"">Costs vary depending on the course and provider. You may choose to pay for an employee to do a HTQ.</p>"),
                new HtmlString(@"<p class=""govuk-body"">Developed by employers to upskill existing employees, provide a different recruitment pool to hire new talent and help your company succeed</p>"),
