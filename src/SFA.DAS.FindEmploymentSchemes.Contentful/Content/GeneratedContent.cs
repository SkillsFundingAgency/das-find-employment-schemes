        ...
        public IEnumerable<Scheme> Schemes => _schemes ??= new Scheme[]
        {
            new Scheme("Apprenticeships",
             ...
             new string[] {                "pay--minimum-wage", "motivations--full-time-role", "motivations--diversity-or-responsibility", "scheme-length--4-months-to-12-months", "scheme-length--a-year-or-more"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Apprentices are paid <a href=""https://www.gov.uk/national-minimum-wage-rates"" title="""" class=""govuk-link app-high-contrast-link"">the minimum wage</a>.</p><p class=""govuk-body"">You may have to contribute 5% of the apprentice's training and assessment costs - depending on the size of your business and the age of your apprentice.</p>"),
...
developing a workforce with skills specific to your business
            ...
            new Scheme("T Levels: industry placements",
             ...
             new string[] {                "pay--unpaid", "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--unpaid-placement", "scheme-length--up-to-4-months"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Read about <a href=""https://www.gov.uk/government/case-studies/how-employers-are-benefitting-from-t-level-industry-placements"" title="""" class=""govuk-link app-high-contrast-link"">how businesses are using T Levels industry placements</a>.</p>"),
                null,
            ...
            new Scheme("Sector-based Work Academy Programme (SWAP)",
             ...
             new string[] {                "pay--unpaid", "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--unpaid-placement", "motivations--full-time-role", "scheme-length--up-to-4-months"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Read about <a href=""https://www.gov.uk/government/case-studies/how-employers-are-benefitting-from-sector-based-work-academies"" title="""" class=""govuk-link app-high-contrast-link"">how employers are using sector-based work academy programmes</a>.</p>"),
                null,
                ...
                new HtmlString(@"<p class=""govuk-body"">Find out <a href=""https://www.gov.uk/government/publications/sector-based-work-academies-employer-guide/sector-based-work-academies-employer-guide"" title="""" class=""govuk-link app-high-contrast-link"">how SWAP could benefit your business</a>.</p>"),
                "Offer a SWAP",
                new HtmlString(@"<p class=""govuk-body"">Contact the Employer Services Line on <a href=""tel:08001690178"" title="""" class=""govuk-link app-high-contrast-link"">0800 169 0178</a></p><p class=""govuk-body"">They will put you in touch with a local Jobcentre Plus employer team.</p>"),
                null,
                new SubScheme[] {
                }
                ),
...
3) is now live and can be accessed here: <a href=""https://www.contractsfinder.service.gov.uk/Notice/6e5dce5a-c772-4e75-ab9c-d6bd5da0f878"" title="""" class=""govuk-link app-high-contrast-link"">Call for competition: Wave 3 Skills Bootcamps Procurement consisting of 7 defined Lots - Contracts Finder</a></p><p class=""govuk-body"">
...
of the course.</p><p class=""govuk-body"">
                ...
                new HtmlString(@"<p class=""govuk-body"">Get started with offering Skills Bootcamps and find providers offering courses in your area.</p><p class=""govuk-body""><a href=""https://www.gov.uk/government/publications/find-a-skills-bootcamp"" title="""" class=""govuk-link app-high-contrast-link"">Find Skills Bootcamps in your area</a></p>"),
                null,
                new SubScheme[] {
                }
                ),
            new Scheme("Traineeships",
             ...
             new string[] {                "pay--unpaid", "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--unpaid-placement", "motivations--full-time-role", "scheme-length--4-months-to-12-months", "scheme-length--up-to-4-months"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Read about <a href=""https://www.gov.uk/government/case-studies/how-employers-are-benefitting-from-traineeships"" title="""" class=""govuk-link app-high-contrast-link"">how businesses are using traineeships</a>.</p>"),
                null,
...
providing a stepping-stone for your future apprentices
...
</li><li>offering financial incentives of up to &#163;1,000 per trainee</li></ul><p class=""govuk-body"">Find out <a href=""https://www.gov.uk/guidance/traineeship-information-for-employers"" title="""" class=""govuk-link app-high-contrast-link"">how traineeships can benefit your business</a>.</p><p class=""govuk-body""></p>"),
                "Offer a traineeship",
                new HtmlString(@"<p class=""govuk-body"">Get started with offering a traineeship.</p><p class=""govuk-body""><a href=""https://www.gov.uk/guidance/traineeship-information-for-employers#get-started"" title="""" class=""govuk-link app-high-contrast-link"">Contact the National Apprenticeship Service</a></p><p class=""govuk-body"">Alternatively, call <a href=""tel:08000150600"" title="""" class=""govuk-link"">08000 150 600</a></p>"),
                null,
                new SubScheme[] {
                }
                ),
            new Scheme("Supported Internships for learners with an education, health and care plan",
             ...
             new string[] {                "pay--unpaid", "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--unpaid-placement", "motivations--full-time-role", "scheme-length--4-months-to-12-months"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Offer a Supported Internship by contacting the lead for your region from the <a href=""https://www.preparingforadulthood.org.uk/about-us/meet-the-team.htm#Regional%20Leads"" title="""" class=""govuk-link app-high-contrast-link"">Preparing for Adulthood Team</a></p>"),
                null,
                new SubScheme[] {
                }
                ),
            new Scheme("Care-Leaver covenant",
             ...
             new string[] {                "pay--unpaid", "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--unpaid-placement", "motivations--full-time-role", "scheme-length--a-year-or-more", "scheme-length--4-months-to-12-months", "scheme-length--up-to-4-months"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Read how <a href=""https://mycovenant.org.uk/covenant-stories/"" title="""" class=""govuk-link app-high-contrast-link"">companies have been making a difference to the lives of care leavers</a></p>"),
                null,
                ...
                new HtmlString(@"<p class=""govuk-body""><a href=""https://mycovenant.org.uk/support-the-covenant/organisation-sign-up/"" title="""" class=""govuk-link app-high-contrast-link"">Find out how to join the Care Leavers Covenant</a> and tailor what opportunities your business would like to offer to care leavers.</p><p class=""govuk-body"">Alternatively, contact the Care Leavers Covenant via telephone on 0800 077 3557</p>"),
                null,
                new SubScheme[] {
                }
                ),
            new Scheme("Employing prisoners and prison leavers",
             ...
             new string[] {                "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--full-time-role", "scheme-length--a-year-or-more", "scheme-length--4-months-to-12-months", "scheme-length--up-to-4-months"             },
                ...
                new HtmlString(@"<p class=""govuk-body"">Read about <a href=""https://newfuturesnetwork.gov.uk/case-studies/#"" title="""" class=""govuk-link app-high-contrast-link"">how businesses are working with serving prisoners and hiring prison leavers</a>.</p>"),
                null,
                ...
                new HtmlString(@"<p class=""govuk-body"">Free government scheme but you may have your own business costs. If you recruit someone you must pay <a href=""https://www.gov.uk/national-minimum-wage-rates"" title="""" class=""govuk-link app-high-contrast-link"">the minimum wage</a>.</p>"),
                ...
                new HtmlString(@"<p class=""govuk-body""><a href=""https://newfuturesnetwork.gov.uk/register/"" title="""" class=""govuk-link app-high-contrast-link"">Register your interest on the New Futures Network</a>.</p><p class=""govuk-body"">A member of the team will be in touch to discuss the process.</p>"),
                null,
                new SubScheme[] {
                }
                ),
            new Scheme("Free courses and additional training for your employees",
             ...
             new string[] {                "pay--unpaid", "pay--minimum-wage", "motivations--diversity-or-responsibility", "motivations--unpaid-placement", "motivations--full-time-role", "scheme-length--a-year-or-more", "scheme-length--4-months-to-12-months", "scheme-length--up-to-4-months"             },
                ...
                new SubScheme[] {
                    ...
                    new HtmlString(@"<p class=""govuk-body"">HTQs have been developed by employers and awarding bodies to help you upskill existing employees and provide a different recruitment pool to hire new talent.</p><p class=""govuk-body"">You can support an employee to undertake an HTQ. The cost is dependent on the course and the provider.</p><p class=""govuk-body"">They are:</p><ul class=""govuk-list govuk-list--bullet""><li>new and existing Level 4 and 5 qualifications (such as Higher National Diplomas, Foundation Degrees, Diploma Higher Education)</li><li>approved by the Institute for Apprenticeships and Technical Education, against employer-led occupational standards</li><li>classroom based and do not require an in-work placement</li></ul><p class=""govuk-body"">The first Digital HTQs will be available for teaching from 2022, leading to higher-level occupations like Network Engineer, Software Developer and Data Analyst.</p><p class=""govuk-body"">Health and Science and Construction qualifications will be available for teaching from 2023, with a full roll-out of further industrial sectors over a four-year period.</p><h3 class=""govuk-heading-m"">Offer a HTQ</h3><p class=""govuk-body""><a href=""https://www.gov.uk/guidance/htqs"" title="""" class=""govuk-link app-high-contrast-link"">Learn more and get started with HTQs.</a></p>")
                    ),
                    ...
                    null,
                    new HtmlString(@"<p class=""govuk-body"">Any adult with low digital skills is entitled to fully funded essential digital skills qualifications, at entry-level and level 1. These equip adults with the full range of essential digital skills needed for life, work, and further study.ÿ</p><p class=""govuk-body"">Funding for other digital skills qualifications may also be available but this will depend on local training providers.</p><p class=""govuk-body"">Find out more about free training courses at <a href=""https://skillsforlife.campaign.gov.uk/"" title="""" class=""govuk-link app-high-contrast-link"">skills for life</a>.</p>")
                    ),
                    new SubScheme("Free level 3 qualifications for adults",
                    null,
                    new HtmlString(@"<p class=""govuk-body"">Free level 3 qualifications are government-funded courses for any adult aged 19 and over, who are looking to achieve a full level 3 qualification. You can also apply for the course if you have done a level 3 qualification before if you are unemployed or earning below national minimum wage.</p><p class=""govuk-body"">A full level 3 qualification is equivalent to an advanced technical certificate, diploma, or A levels.</p><p class=""govuk-body""><a href=""https://www.gov.uk/guidance/free-courses-for-jobs"" title="""" class=""govuk-link app-high-contrast-link"">The Free Courses for jobs</a> offer and the qualification list has been developed with industry and will be regularly reviewed.</p>")
                    ),
                    new SubScheme("National Careers Service",
                    null,
                    new HtmlString(@"<p class=""govuk-body"">The National Careers Service is free to use and can help you explore work and skill opportunities for your workforce.</p><p class=""govuk-body"">Find out more about <a href=""https://nationalcareers.service.gov.uk/"" title="""" class=""govuk-link app-high-contrast-link"">the National Careers Service and how to contact them</a>.</p>")
                    ),
                }
                ),
        };
       ...
       private Filter? _schemeLengthFilter;
        ...
        public IEnumerable<Page> Pages => _pages ??= new Page[]
        {
            ...
            new Page("AnalyticsCookies",
                "analyticscookies",
                new HtmlString(@"<h1 class=""govuk-heading-xl"">Details about cookies</h1><p class=""govuk-body"">This service puts small files (known as &#39;cookies&#39;) onto your computer. These cookies are used to:</p><ul class=""govuk-list govuk-list--bullet""><li>help us understand how you use the website, so we can make improvements</li><li>remember what notifications you&#39;ve seen so you&#39;re not shown them more than once</li><li>temporarily store the selections you make</li></ul><p class=""govuk-body"">Find out more about&#160;<a href=""https://ico.org.uk/your-data-matters/online/cookies/"" title="""" class=""govuk-link app-high-contrast-link"">how to manage cookies</a>.</p><h2 class=""govuk-heading-l"">Cookies that measure website usage</h2><p class=""govuk-body"">We use Google Analytics software (Universal Analytics) to collect anonymised information about how you use the service. We do this to help make sure the service is meeting the needs of its users and to help us make improvements.</p><p class=""govuk-body"">We do not allow Google to use or share the data about how you use this service.</p><p class=""govuk-body"">Google Analytics stores information about:</p><ul class=""govuk-list govuk-list--bullet""><li>how you got to the service</li><li>the pages you visit on this service and how long you spend on them</li><li>what you click on while you&#39;re visiting the service</li></ul><p class=""govuk-body"">We may also set our own cookies to understand how people move through the service.</p><p class=""govuk-body""></p>")
            ),
            new Page("MarketingCookies",
                "marketingcookies",
                new HtmlString(@"<h2 class=""govuk-heading-l"">Cookies that help with our communications and marketing</h2><p class=""govuk-body"">Some of our pages may contain content from other sites, like YouTube, which may set their own cookies. These sites are sometimes called &#39;third party&#39; services. This tells us how many people are seeing the content and whether it&#39;s useful.</p><p class=""govuk-body"">We also share information about your use of our pages with our social media and advertising partners (for example, Facebook) to help us improve the relevancy of advertising campaigns you receive from us.</p><p class=""govuk-body"">They may set cookies that you can turn off. Find out more about how to&#160;<a href=""https://ico.org.uk/your-data-matters/online/cookies/"" title="""" class=""govuk-link app-high-contrast-link"">turn off these cookies</a>.</p><p class=""govuk-body"">In addition, if you share a link to one of our pages, the service you share it on (for example, Facebook) may set a cookie. We have no control over cookies set on other websites - you can turn them off, but not through us.</p><p class=""govuk-body""></p>")
            ),
...
<a href=""https://mcmw.abilitynet.org.uk/"" title="""" class=""govuk-link app-high-contrast-link"">AbilityNet</a> has advice on making your device easier to use if you have a disability.
...
<a href=""ESFA.GOVUK-ENQUIRIES@education.gov.uk "" title="""" class=""govuk-link app-high-contrast-link"">ESFA.GOVUK-ENQUIRIES@education.gov.uk </a>
...
If you find any problems not listed on this page or think we're not meeting accessibility requirements, contact: <a href=""ESFA.GOVUK-ENQUIRIES@education.gov.uk "" title="""" class=""govuk-link app-high-contrast-link"">ESFA.GOVUK-ENQUIRIES@education.gov.uk</a>.
...
</p><p class=""govuk-body"">If you're not happy with how we respond to your complaint, <a href=""https://www.equalityadvisoryservice.com/"" title="""" class=""govuk-link app-high-contrast-link"">contact the Equality Advisory and Support Service (EASS)</a>.
...
This website is fully compliant with the <a href=""https://www.w3.org/TR/WCAG21/"" title="""" class=""govuk-link app-high-contrast-link"">Web Content Accessibility Guidelines version 2.1 AA standard</a>.
