...
new string[] {"minimum-wage",
"full-time-role",
"diversity-or-responsibility",
...
new HtmlString(@"<p>Get started with offering an apprenticeship.</p><p><a href=""https://www.apprenticeships.gov.uk/employers/hiring-an-apprentice"" title="""" class=""govuk-link"">Hire an apprentice</a></p><p>Alternatively, call <a href=""tel:08000150400"" title="""" class=""govuk-link"">08000 150 400</a></p>")
),
...
new HtmlString(@"<p>Get started with offering an industry placement.</p><p><a href=""https://employers.tlevels.gov.uk/hc/en-gb/requests/new"" title="""" class=""govuk-link"">Take the next steps with T Levels</a></p><p>Alternatively, call <a href=""tel:08000150600"" title="""" class=""govuk-link"">08000 150 600</a> (choose option 4)</p>")
),
...
"Offer a traineeship",
new HtmlString(@"<p>Get started with offering a traineeship.</p><p><a href=""https://www.gov.uk/guidance/traineeship-information-for-employers#get-started"" title="""" class=""govuk-link"">Contact the National Apprenticeship Service</a></p><p>Alternatively, call <a href=""tel:08000150600"" title="""" class=""govuk-link"">08000 150 600</a></p>")
),
...
new HtmlString(@"<p>Employers must provide:</p><ul class =""govuk-list govuk-list--bullet""><li>a safe work environment</li><li>an induction which includes explaining relevant policies and procedures</li><li>practical help that makes a difference to the life of a care leaver</li></ul><p></p>"),
...
new HtmlString(@"<p>Employers must provide:</p><ul class =""govuk-list govuk-list--bullet""><li>a safe work environment</li><li>a line manager to support, supervise and mentor</li><li>an induction which includes explaining relevant policies and procedures</li></ul><p></p>"),
...
new MotivationsFilter("diversity-or-responsibility",
"To diversify our workforce or for corporate and social responsibility"
),
new MotivationsFilter("unpaid-placement",
"To offer someone an unpaid work placement opportunity"
),
new MotivationsFilter("full-time-role",
...
new PayFilter("diversity-or-responsibility",
"To diversify our workforce or for corporate and social responsibility"
),
new PayFilter("unpaid-placement",
"To offer someone an unpaid work placement opportunity"
),
new PayFilter("full-time-role",
"To help train someone up into a full-time role"
),
        };
...
new SchemeLengthFilter("diversity-or-responsibility",
"To diversify our workforce or for corporate and social responsibility"
),
new SchemeLengthFilter("unpaid-placement",
"To offer someone an unpaid work placement opportunity"
),
new SchemeLengthFilter("full-time-role",
"To help train someone up into a full-time role"
),
        };
    }
