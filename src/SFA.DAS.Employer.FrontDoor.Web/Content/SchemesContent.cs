...
"apprenticeships", 403000, new HtmlString(""),
...
"t-levels-industry-placements", 72000, new HtmlString(""),
...
"sector-based-work-academy-programme-swap", 70000, new HtmlString(""),
...
"skills-bootcamps", 68000, new HtmlString(""),
...
"traineeships", 43000, new HtmlString(""),
...
"supported-internships-for-learners-with-an-education-health-and-care-plan", 20000, new HtmlString(""),
