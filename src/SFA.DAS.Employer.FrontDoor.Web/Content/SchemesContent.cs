...
new HtmlString(@"<p>Level 4 or 5 qualifications, for over 18s, with no work placement but flexible for employees to study while working.</p>"),
new HtmlString(@"<p>Free government scheme but you may have your own business costs</p>"),
new HtmlString(@"<p>Developed by employers to upskill existing employees, provide a different recruitment pool to hire new talent and help your company succeed</p>"),
new HtmlString(@"<p>1 to 2 years</p>"),
"higher-technical-qualifications", -500, null,
new HtmlString(@"<p>Higher Technical Qualifications (HTQs) are a high-quality addition to technical training routes, alongside apprenticeships, traineeships and degrees.</p><p>They are:</p><ul class =""govuk-list govuk-list--bullet""><li><p>new and existing Level 4 and 5 qualifications (such as Higher National Diplomas, Foundation Degrees, Diploma Higher Education)</p></li><li><p>approved by the Institute for Apprenticeships and Technical Education, against employer-led occupational standards</p></li></ul><p>The first Digital HTQs will be available for teaching from 2022, leading to higher-level occupations like Network Engineer, Software Developer and Data Analyst.</p><p>Health and Science and Construction qualifications will be available for teaching from 2023, with a full roll-out of further industrial sectors over a four-year period.</p>"),
new HtmlString(@"<p>You may choose to pay for an employee to undertake a HTQ. Costs will vary depending on the course and provider.</p>"),
new HtmlString(@"<p>Most HTQs do not require an in-work placement.</p>"),
new HtmlString(@"<p>HTQs have been developed by employers and awarding bodies to help you upskill existing employees and provide a different recruitment pool to hire new talent.</p><p>They help your workforce have the right knowledge, skills and behaviours for your company to succeed.</p>"),
null,
"Offer HTQs",
new HtmlString(@"<p><a href=""https://www.gov.uk/guidance/htqs"" title="""" class=""govuk-link"">Learn more and get started with HTQs</a>.</p>")),
